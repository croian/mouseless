...
Mouseless must use the network to start a trial and to validate licenses (purchased licenses store an offline license that must be refreshed every 30 days -- the program attempts to do this automatically).
